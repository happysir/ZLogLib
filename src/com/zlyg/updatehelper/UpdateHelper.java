...
import com.zlyg.log.handler.R;
import com.zlyg.updatehelper.UpdateListener.ForceUpdateListener;
import com.zlyg.updatehelper.UpdateListener.NormalUpdateListener;
...
public class UpdateHelper {
 ...
 //       mNotificationHelper = new NotificationHelper(activity, mPackageHelper);
    ...
    private void showDialog(final UpdateInfoBean bean) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(mActivity,R.style.ActivityDialog);
        builder.setIcon(android.R.drawable.ic_dialog_alert);
        builder.setView(scrollView);
        builder.setTitle("发现新版本");
        builder.setMessage("是否下载?");
        builder.setPositiveButton("下载更新", positiveBtnLsnr);
        if (mUpdateListener instanceof ForceUpdateListener) {
    ...
    public void downApk(UpdateInfoBean bean) {
    ...
    //            mNotificationHelper.refreshProgress(percent);
            ...
            public void onSuccess(File file) {
                chmod(file);
                if (mUpdateListener !=null && mUpdateListener instanceof NormalUpdateListener) {
                    ((NormalUpdateListener) mUpdateListener).onDownloadFinish(file);
                }
