...
public abstract class AbsSendReportsService extends Service {
	  public static final String INTENT_BROADCAST = "android.intent.crash.reporter.BROADCAST";
	    public static final String INTENT_DIR = "android.intent.carsh.reporter.DIR";
	    public static final String INTENT_EXTENSION = "android.intent.crash.reporter.EXTENSION";
	    ...
	    private static final String TAG = "AbsSendReportService";
	        ...
	        AjaxCallBack<String> httpGetCallBack = new AjaxCallBack<String>() {
	            ...
	            public void onSuccess(String t) {// wifi可用
	                if (t != null && t.indexOf(NETWORK_TEST_HOST_KEYWORD) > -1) {
	                    ...
	                    if (zipFile != null) {
	                        // 发送报告
	                        sendZipReportsToServer(zipFile);
	                    } else {
	                        stopSelf();
	                    }
	                } else {
	            ...
	            @Override
	            public void onFailure(Throwable t,int arg1, String strMsg) {
	                stopSelf();
	            }
	        };
