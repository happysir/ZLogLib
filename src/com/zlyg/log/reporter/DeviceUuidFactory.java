...
class DeviceUuidFactory {
     ...
     * a new device ID
     * may be generated. In addition, if a user upgrades their phone from certain buggy
     * implementations of Android 2.2
     * to a newer, non-buggy version of Android, the device ID may change. Or, if a user uninstalls
     * your app on
     * a device that has neither a proper Android ID nor a Device ID, this ID may change on
     * reinstallation.
